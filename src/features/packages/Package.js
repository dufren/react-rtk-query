...
const Package = ({ id }) => {
    ...
    const [isSelected, setIsSelected] = useState(JSON.parse(sessionStorage.getItem(item.id)) || false)
    ...
    return (
        <div className={`bg-gray-100 mb-10 p-10 rounded-md shadow hover:shadow-2xl ${selectBorder}`} onClick={addToCartHandle}>
